...
const pdfButton = template.content.lastElementChild;

function sendExportMessage(action) {
...
button.addEventListener('click', () => sendExportMessage('downloadHtml'));
pdfButton.addEventListener('click', () => sendExportMessage('printPdf'));
